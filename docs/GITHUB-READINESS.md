...
| 5 | Model-weights redistribution terms | **Resolved** | OvisOCR2 base model is Apache-2.0 (ATH-MaaS, no upstream NOTICE file). Bartowski GGUF quantizations carry no extra restrictions (CEO verified 2026-08-23). Distribution stays on Google Drive regardless. |
...
- **Fresh repository** with a different username (not a fork of the private repo).
- **Public at app v1.1** — after the FILE_TOO_COMPLEX tooltip fix and any additional polish.
