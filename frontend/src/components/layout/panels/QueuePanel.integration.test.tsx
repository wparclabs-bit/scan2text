...
function createTestJobs() {
  return {
    'job-queued': { id: 'job-queued', fileName: 'queued.png', fileSize: 500, fileType: 'image/png', status: 'pending' as const, createdAt: 1000, taskId: null, isBackground: false, resultMarkdown: null, markdownOutput: '', error: null, errorCode: null, file: null, progress: 0, consecutiveHealthFailures: 0 },
    'job-processing': { id: 'job-processing', fileName: 'processing.png', fileSize: 600, fileType: 'image/png', status: 'processing' as const, createdAt: 2000, taskId: 'task-1', isBackground: false, resultMarkdown: null, markdownOutput: '', error: null, errorCode: null, file: null, progress: 45, consecutiveHealthFailures: 0 },
    'job-completed': { id: 'job-completed', fileName: 'done.pdf', fileSize: 700, fileType: 'application/pdf', status: 'completed' as const, createdAt: 3000, taskId: 'task-2', isBackground: true, resultMarkdown: '# Done', markdownOutput: '# Done', error: null, errorCode: null, file: null, progress: 100, consecutiveHealthFailures: 0 },
    'job-failed': { id: 'job-failed', fileName: 'failed.png', fileSize: 800, fileType: 'image/png', status: 'failed' as const, createdAt: 4000, taskId: 'task-3', isBackground: false, resultMarkdown: null, markdownOutput: '', error: 'OCR error', errorCode: null, file: null, progress: 0, consecutiveHealthFailures: 0 },
  }
}
