...
- **Current Slice:** Slice 6.14j (Absolute Viewport Lock — fixed inset-0 shell)
...
- **Tests:** 544/544 passing (33 files; -7 from removed radiant rays/ambient glow tests, +8 new viewport lock + scroll-area neutralizer tests)
